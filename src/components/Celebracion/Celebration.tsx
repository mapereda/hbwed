...
const Celebration: React.FC = () => {
  return (
    <div className="Celebration">
      <span className="texto">La ceremonia tendrá lugar el domingo siete de diciembre de dos mil veinticinco, en la finca El Campillo, a la una de la tarde.</span>
      <span className="texto">La recepción de invitados comenzará a las doce y media.</span>
      <div className="Adress">
        <span className="Label">Dirección: </span>
        <span className="texto">Finca El Campillo, 1.8, M-600, 28200 San Lorenzo de El Escorial, Madrid</span>
      </div>
